        ...
        <div class="container offset mb-4">
            <div class="about-main">
                <div class="about-right">
                    <h3 class="subheading-w3-agile text-center">Admin Login</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            ...
                            <a href="<?=base_url('Admin_controller/register_admin')?>" class="text-dark font-weight-bold" style="color: white">
                                Register Now</a></p> -->
                            </form>
                        </div>
                    </div>
