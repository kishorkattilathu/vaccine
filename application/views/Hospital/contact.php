            ...
            <div class="row contact-form py-lg-5">
                ...
                <div class="col-lg-6 wthree-form-left mt-lg-0 mt-3">
                    ...
                    <div class="contact-top1">
                        ...
                        <form action="<?=base_url('Hospital_controller/contact/'.$det->hospital_id)?>" method="post"  class="f-color pt-3">
                            <div class="form-group">
                                <label for="contactusername">Name</label>
                                <input type="text" class="form-control" name="name" value="<?=$det->hospital_name?>" id="contactusername" readonly >
                            </div>

                            <input type="hidden" name="id" value="<?=$det->hospital_id?>">

                            <div class="form-group my-4">
                                <label for="contactemail">Email</label>
                                <input type="email" class="form-control" value="<?=$det->hospital_email?>" name="email" id="contactemail" readonly>
                            </div>
                            <div class="form-group">
