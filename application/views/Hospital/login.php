        ...
        <div class="container offset mb-4">
            <div class="about-main">
                <div class="about-right">
                    <h3 class="subheading-w3-agile text-center">Hospital Login</h3>
                    <!-- stats -->
                    <div class="stats">
                        <div class="stats_inner">
                            <form action="<?=base_url('Hospital_controller/login')?>" method="post">
                               
                               
                                <input class="form-control mb-3" type="email" placeholder="E-mail" name="email" required="">
                                <input class="form-control mb-3" id="password" name="password" placeholder=""  type="password" required="">
                                <button type="submit" name="button" class="btn btn-agile btn-block w-100">Log in</button><br>
                                 <p class="text-center dont-do" style="color: white">Don't have an account?
                            <a href="<?=base_url('Hospital_controller/hospital_register')?>" class="text-dark font-weight-bold" style="color: white">
                                Register Now</a></p>
                            </form>
                        </div>
                    </div>
