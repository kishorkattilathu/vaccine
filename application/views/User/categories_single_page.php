            ...
            <div class="agileits-about-row row  text-center pt-lg-5">
                ...
                <div class="col-lg-4 col-sm-6 agileits-about-grids">
                    <div class="p-md-5 p-sm-3">
                      <a href="<?=base_url('User_controller/hospital_vaccine_page/'.$cat->cat_id.'/'.$det->hospital_id)?>"> <img style="height: 209px;width: 194px" src="<?=base_url('Assets/Admin/category/'.$cat->cat_image)?>"></a>
                        <h4 class="mt-2 mb-3"><?=$cat->cat_name?></h4>
                    </div>
                </div>
